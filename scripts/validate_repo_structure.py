...
REQUIRED_PATHS = [
    ...
    "docs/reviews/security-delta-review-process.md",
    "docs/assessments/README.md",
    "docs/methodology/README.md",
    "docs/strategy/README.md",
    "docs/templates/README.md",
    "docs/templates/security-delta-review-template.md",
    "registers/README.md",
    ...
    "registers/security-change-record-index.yaml",
    "scripts/README.md",
    "scripts/render_register_views.py",
    "scripts/render_security_change_record_index.py",
