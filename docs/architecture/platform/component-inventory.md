...
| Temporal | durable workflow runtime | persists workflow history, waits, retries, and activity dispatch behind OOS without owning business authority | [`../components/temporal/README.md`](../components/temporal/README.md) |
...
| governed-ai-gateway | governed AI access-plane boundary | keeps provider credentials in platform custody, emits audit, and blocks direct-provider consumer bypass for AI-assisted workflows | [`../components/governed-ai-gateway/README.md`](../components/governed-ai-gateway/README.md) |
| workspace-prototype-studio | product-incubation source lane | can shape internal tools and client app prototypes before graduation, so data mode, visibility, and mutation boundaries must stay explicit | [`../components/workspace-prototype-studio/README.md`](../components/workspace-prototype-studio/README.md) |
