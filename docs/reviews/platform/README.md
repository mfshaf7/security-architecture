...
This directory contains dated platform-wide security review outputs.

Use this lane when the review scope is a shared platform control, cross-product
control plane, or platform delivery boundary rather than a single component or
product feature.
